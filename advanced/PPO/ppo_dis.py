...
class PPO:
    ...
    def update(self, transition_dict):
        # actions rewards dones 进行了.view(-1, 1)
        # 而 states next_states 则没有 思考为什么
        states = torch.tensor(
        ...
        for _ in range(self.epochs):
            ...
            surr1 = ratio * advantage # 未裁剪的优势
            surr2 = torch.clamp(
                ratio, 1-self.eps, 1+self.eps
            ) * advantage
